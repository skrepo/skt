...
# Meta category        Advanced Encryption Standard (AES)
# Meta description     Implementation of the AES block cipher
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.5}
# Meta subject         security {data integrity} aes {block cipher}
# Meta subject         encryption
# Meta summary         aes
# @@ Meta End
